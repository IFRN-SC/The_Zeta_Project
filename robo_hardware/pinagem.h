...
class pinagem{
  ...
  #define SENSOR_LINHA_MAIS_ESQUERDO	A2		//Define o pino do sensor de refletancia mais esquerdo
  #define SENSOR_LINHA_MAIS_DIREITO	A3		//Define o pino do sensor de refletancia mais direito
